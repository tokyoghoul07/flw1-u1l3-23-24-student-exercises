...
let ceeatrueName = "nana"


// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.
let creatureDescription = "An orignal vampire who can submit a human to do anything they want"
...
let vistorAge = MAth.round(visitorAgeDecimal);
...
let zoosummary = "Nana can vist" + creatureName 
